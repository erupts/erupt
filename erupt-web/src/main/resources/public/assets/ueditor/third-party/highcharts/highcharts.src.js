		...
		// setter
			...
			for (key in hash) {
				...
				if (result !== false) {
					...
					// let the shadow follow the default element
...
Axis.prototype = {
	...
	setAxisSize: function () {
		...
		// Expose default values to use in Series object and navigator
...
var AreaSeries = extendClass(Series, {
	...
	drawGraph: function () {
		...
		var series = this,
			...
			props = [['area', this.color, options.fillColor]]; // area name, default color, fill color
...
var SplineSeries = extendClass(Series, {
	...
	getPointSpline: function (segment, point, i) {
		...
		if (lastPoint && nextPoint) {
			...
			// have the two control points make a straight line through default point
...
var ColumnSeries = extendClass(Series, {
	...
	/**
	 * Override the default data label alignment by adjusting for the position of the column
	 */
	alignDataLabel: function (point, dataLabel, options,  alignTo, isNew) {
		var chart = this.chart,
			inverted = chart.inverted,
...
var PieSeries = {
	...
	/**
	 * Extend the default setData method by running processData and generatePoints immediately,
