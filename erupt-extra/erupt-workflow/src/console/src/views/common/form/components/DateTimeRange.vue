<template>
  <div>
    <div v-if="mode === 'DESIGN'">
      <el-date-picker v-model="_value" :end-placeholder="placeholder[1]" :start-placeholder="placeholder[0]" :type="type" disabled size="medium"/>
    ...
    <div v-else>
      <el-date-picker v-model="_value" :disabled="!editable" :end-placeholder="placeholder[1]" :start-placeholder="placeholder[0]" :type="type" :value-format="format" clearable size="medium"/>
      <div v-if="showLength" class="length">
        <span>时长：</span>
        <span>{{timeLength}}</span>
      </div>
