<template>
  <div>
    <div v-if="mode === 'DESIGN'">
      <el-button icon="el-icon-paperclip" round size="small">选择文件</el-button>
      <ellipsis slot="tip" :content="placeholder + sizeTip" :row="1" class="el-upload__tip" hoverTip/>
    </div>
    <div v-else>
      <el-upload :action="uploadUrl" :auto-upload="true" :before-upload="beforeUpload" :data="uploadParams" :disabled="!editable"
                 :file-list="_value"
                 ...
                 with-credentials
      >
        <el-button :disabled="!editable" icon="el-icon-paperclip" round size="small">选择文件</el-button>
        <ellipsis slot="tip" :content="placeholder + sizeTip" :row="1" class="el-upload__tip" hoverTip/>
      </el-upload>
    </div>
  </div>
