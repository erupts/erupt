<template>
  <el-popover placement="bottom-start" title="添加流程节点" trigger="click" width="350">
    ...
    <el-button slot="reference" circle icon="el-icon-plus" size="small" type="primary"></el-button>
  </el-popover>
</template>
